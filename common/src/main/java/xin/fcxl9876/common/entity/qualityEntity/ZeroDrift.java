...
public class ZeroDrift implements Serializable {
    ...
    /** 绝对误差技术标准 **/
    @Column(name="absolute_technical_requirement")
    private String absoluteTechnicalRequirement;

    /** 相对误差技术标准 **/
    @Column(name="relative_technical_requirement")
    private String relativeTechnicalRequirement;
