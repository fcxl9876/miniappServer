...
public final class Constants {
    ...
    public static final String USER_NOT_FOUND = "未发现用户信息";

    public static final String ILLEGAL_PARAM = "非法参数";

    public static final String WEEK_PARAM_ILLEGAL = "周时间不是周一开始、周日结束";
    ...
    public static final String SAVE_FAILUE = "保存失败";

    public static final String CHECK_FEGIN_SERVICE = "请检查fegin服务是否启动或注册";

    public static final String BIND_STATION_PROJECT = "请关联站点因子";

    public static final String STATION_NOT_FOUND = "找不到该站点";
}
